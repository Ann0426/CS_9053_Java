...
public class ObjectPrinter<T extends GeometricObject> {
	...
	public static ObjectPrinter<GeometricObject> appendList(ObjectPrinter<GeometricObject> origList, 
															List<? extends GeometricObject> newItemList) {
	...
	public static ObjectPrinter<GeometricObject> appendCircleList(ObjectPrinter<GeometricObject> origList, 
															List<Circle> newItemList) {
